...
// Настройка интенсивности crepuscular rays
#ifndef CREPUSCULAR_RAYS_BOOST
#define CREPUSCULAR_RAYS_BOOST 1.0 // Увеличь это значение для усиления лучей (например, 2.0, 3.0, 5.0)
#endif
...
vec4 draw_crepuscular_rays(
    ...
    scattering *= (6.0 * CREPUSCULAR_RAYS_INTENSITY) * phase * CREPUSCULAR_RAYS_BOOST; // Применяем усиление
    transmittance =
